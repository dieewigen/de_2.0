...
mysql_query("INSERT INTO de_news_overview (typ, betreff, nachricht, time) VALUES (2,'$betreff','$nachricht','$time')");
...
<table border="0" width="750">
  ...
  $sel_news=mysql_query("SELECT * FROM de_news_overview where typ=2 order by id desc");
