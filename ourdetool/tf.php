...
if ($uid > 0) {
    echo '<a href="#eingang">Eingang</a> | <a href="#ausgang">Ausgang</a> | <a href="#archiv">Archiv</a>';

    echo '<h2 id="eingang">Eingang</h2>';
    ...
    while ($row = mysqli_fetch_array($db_tfn)) { //jeder gefundene datensatz wird ausgegeben
        ...
        echo '<table cellpadding="0" cellspacing="2" width="500">';
        echo '<tr>';
        ...
        echo '</tr>';
        echo '</table>';
        echo '<table cellpadding="0" cellspacing="1" width="500">';
        echo '<tr>';
