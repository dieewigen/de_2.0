...
<form method="post" action="<?php echo $PHP_SELF; ?>?site"><input type="submit" name="refresh" value="Seite aktualisieren"></form>

<table border="1" cellspacing="0" cellpadding="5">
 <tr><td class="bt" style="text-align: left;"><u>Zeitung</u> [<a href="<?php echo $PHP_SELF; ?>?order=1">S</a>]</td><td class="ubt">Status</td><td>&nbsp;</td><td class="bt"><u>Herausgeber</u> [<a href="<?php echo $PHP_SELF; ?>?order=2">S</a>]</td><td>&nbsp;</td><td class="ubt">Logo</td><td class="ubt">Ausgaben</td><td class="bt"><u>lA</u>  [<a href="<?php echo $PHP_SELF; ?>?order=3">S</a>]</td></tr>
<?php
