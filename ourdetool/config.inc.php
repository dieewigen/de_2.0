...
$cfgHTPasswd[0][D] = '[Gesch�tzter Bereich] (Administration)';
//$cfgHTPasswd[1][N] = 'c:\pfad\zur\passwd\passwd2';
//$cfgHTPasswd[1][D] = '[Gesch�tzter Bereich] mehr bla bla bla (Administration)';
...
function init_passwd_file($filenum, $htfunction) {
  ...
  if (!is_writeable($cfgHTPasswd[$filenum][N]))
    ht_error(".htpasswd ($filenum) Datei ist schreibgesch�tzt / nicht schreibbar", $htfunction);
}
