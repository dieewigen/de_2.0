...
if($_REQUEST["mp"]==1)
{
  ...
  echo'
    ...
    <img src="statistics_genpic.php?typ=1">
    <br><br><div class="cellu" style="width: 600px;">'.$stat_lang[kollektorentwicklung].'</div><br><br>
    <img src="statistics_genpic.php?typ=2">
    <br><br><div class="cellu" style="width: 600px;">'.$stat_lang[cybentwexp].'</div><br><br>
    <img src="statistics_genpic.php?typ=3"><br><br>';
  //aktivit�t
