...
for($i=0;$i<count($artefaktpreis);$i++)
{
  ...
  if($artefaktpreis[$i]==0)$artefaktpreis[$i]=1;
}
...
if($sv_deactivate_blackmarket==1){
	include "resline.php";
...
$remsubmit2=$_GET['remsubmit2'];
$remsubmit3=$_GET['remsubmit3'];
...
$remsubmit107=$_GET['remsubmit107'];
...
if ($errmsg!='')echo '<br><div class="info_box">'.$errmsg.'</div>';
