...
<head>
<?php
if ($s!="a")echo '<title>'.$sn_lang["nachrichten"].'</title>';
else echo '<title>'.$sn_lang["alle"].' '.$sn_lang["nachrichten"].'</title>';
?>
...
if ($_GET["a"]=="d"){//alle nachricht l&ouml;schen
