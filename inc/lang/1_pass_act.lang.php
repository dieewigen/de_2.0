<?php
$passact_lang['actmailbetreff']='Best&auml;tigungsmail f&uuml;r die Anmeldung bei Die Ewigen';
...
Sie haben Ihre Zugangsdaten f&uuml;r Die Ewigen angefordert
und es wurde ein alternatives Passwort generiert.

Sollten sie sich mit dem neuen Passwort einloggen,
so verliert das alte Passwort seine G&uuml;ltigkeit.
...
$passact_lang['msg1']='Sollte man sein Passwort vergessen haben, so kann man hier ein neues Passwort aktivieren, das zus&auml;tzlich zu dem alten Passwort funktioniert. Bei dessen erster Benutzung wird dann das alte durch das neue Passwort ersetzt.';
...
$passact_lang['msg3']='Eins der beiden Felder muss ausgef&uuml;llt werden.';
