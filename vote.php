...
$gespielteticks=$row["tick"];$sector=$row["sector"];$system=$row["system"];
...
<td class="rol">&nbsp;</td>
<td class="ro"><div class="cellu"><?=$vote_lang[aktuelleumfragen]?></div></td>
<td class="ror">&nbsp;</td>
</tr>
...
<tr height="37" align="center">
<td class="rol">&nbsp;</td>
<td class="ro"><div class="cellu"><?=$vote_lang[alteumfragen]?></div></td>
<td class="ror">&nbsp;</td>
</tr>
...
$db_checkobende=mysql_query("Select frage, antworten, hinweis, stimmen, status, startdatum, enddatum, ergebnisse from de_vote_umfragen where status=2 and id='$id'");
              ...
              if(mysql_num_rows($db_checkobende)>0)
              {
                      ...
                      ?>
                      <br><br>
                      <a href="javascript:history.back()"><div class="cellu"><b><?=$vote_lang[zzu]?></b></div></a>
                      <br><br>
                      ...
                      <td>
                               ...
                               <tr height="20">
                               <td class="cell"  cellspacing="2">&nbsp;<?=$vote_lang[start]?>: <? echo str_replace(" ","&nbsp;&nbsp;/&nbsp;&nbsp;",$row[startdatum]); ?></td>
                               ...
                               <tr height="25">
                               <td class="cell">&nbsp;<?=$vote_lang[ende]?>: <? echo str_replace(" ","&nbsp;&nbsp;/&nbsp;&nbsp;",$row[enddatum]); ?></td>
                               ...
                               ?>
                               <img src="<? echo $ums_gpfad; ?>g/vote/l<? echo $farbe; ?>.gif" border="0"><img src="<? echo $ums_gpfad; ?>g/vote/m<? echo $farbe; ?>.gif" border="0" width="<? echo $prozente;?>" height="9"><img src="<? echo $ums_gpfad; ?>g/vote/r<? echo $farbe; ?>.gif">
                               <?
