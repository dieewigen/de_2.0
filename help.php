...
$newtrans=$row["newtrans"];$sector=$row["sector"];$system=$row["system"];
...
$a=(int)$a;
$artresult = mysql_query("SELECT id, artname, artdesc, color FROM de_artefakt ORDER by id",$db);
...
?>
<div class="cell" style="width: 250px;"><a href="javascript:history.back();"><?=$help_lang[zurueck]?></a>
<br><br>
