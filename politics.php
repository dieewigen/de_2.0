        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr align="center">
                ...
                <td width="550" align="center" class="ro">
                    <div class="cellu">Sektorname</div>
                </td>
            ...
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["sektax"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
            <tr align="center">
            ...
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["markvoteout"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
            <tr align="center">
...
<td width="13" height="25" class="rl">&nbsp;</td>';
    ...
    echo '<br><font size="2">' . $politics_lang["actualsk"] . ': ';
   ...
   ORDER BY `system` ASC",
    ...
    echo '
    <br><br>
    <select size="1" name="userslist">
        <option value="0">für niemanden stimmen</option>';
    ...
    ?>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["allgemeineinfos"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
            <tr align="center">
   ...
   ORDER BY tech_id",
            ...
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["sektorlagereinzahlungen"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
  ...
  <td width="110" class="' . $bg . '"><b>' . $politics_lang["tronic"] . '</td>
            ...
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["spielerinformationen"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
  ...
  <td width="33%" class="' . $bg . '"><b>' . $politics_lang["sektorstatuseinsicht"] . '</td>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td class="' . $bg . '">';
                            if (strtotime($row["last_click"]) + 43200 > time()) echo $politics_lang["ja"];
                            else echo $politics_lang["nein"];
                            echo '</td>';
            ...
            ?>
                <tr align="center">
                    <td width="13" height="37" class="rml">&nbsp;</td>
                    <td width="550" align="center" class="ro">
                        <div class="cellu"><?php echo $politics_lang["umzugmsg"] ?></div>
                    </td>
                    <td width="13" class="rmr">&nbsp;</td>
                </tr>
                </tr>
    ...
    <input type="submit" value="' . $politics_lang["selsek"] . '" name="joinsec"><br><br>';
            ...
            ?>
                <tr align="center">
                    <td width="13" height="37" class="rml">&nbsp;</td>
                    <td width="550" align="center" class="ro">
                        <div class="cellu"><?php echo $politics_lang["exilvote"] ?></div>
                    </td>
                    <td width="13" class="rmr">&nbsp;</td>
                </tr>
                </tr>
  ...
  WHERE de_user_data.sector=? AND de_login.status=1 ORDER BY `system` ASC ",
            ...
            <tr align="center">
                <td width="13" height="37" class="rml">&nbsp;</td>
                <td width="550" align="center" class="ro">
                    <div class="cellu"><?php echo $politics_lang["knownartis"] ?></div>
                </td>
                <td width="13" class="rmr">&nbsp;</td>
            </tr>
            </tr>
