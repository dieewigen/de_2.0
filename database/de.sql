...
CREATE TABLE `de_user_data` (
  ...
  `kg01` bigint(20) UNSIGNED NOT NULL,
  `kg02` bigint(20) UNSIGNED NOT NULL,
  `kg03` bigint(20) UNSIGNED NOT NULL,
  `kg04` bigint(20) UNSIGNED NOT NULL,
  `kgget` bigint(20) UNSIGNED NOT NULL,
  ...
  `sou_user_id` mediumint(8) UNSIGNED NOT NULL,
...
CREATE TABLE `de_user_info` (
  ...
  `observation_by` char(20) NOT NULL,
