...
$db = @mysql_connect($GLOBALS['env_db_dieewigen_host'], $GLOBALS['env_db_dieewigen_user'], $GLOBALS['env_db_dieewigen_password'], true) or die("Keine Verbindung zur Datenbank möglich.");
mysql_select_db($GLOBALS['env_db_dieewigen_database'], $db);

$GLOBALS['dbi'] = mysqli_connect($GLOBALS['env_db_dieewigen_host'], $GLOBALS['env_db_dieewigen_user'], $GLOBALS['env_db_dieewigen_password'], $GLOBALS['env_db_dieewigen_database']) or die("Keine Verbindung zur Datenbank möglich.");
