...
//maximalen geb�udelevel auslesen
...
if($player_in_hb>0)
{
  ...
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  //�berpr�fen ob man k�mpfen m�chte
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  if($_REQUEST["hbdo"]==1 AND $player_atimer1time<=time() AND $_REQUEST['st']==$_SESSION['sou_hb_token'])
  {
    ...
    //�berpr�fen ob man auf der stufe zugreifen kann
  	if(($id+1)<=$geb_level OR $geb_level>=50)
  	{
    	//�berpr�fen ob man genug aktionspunkte hat
    	if($player_hb_ap>0)
    	{
    		$player_hb_ap--;
  	  ...
  	  //////////////////////
  	  //////////////////////
  	  //spielerdaten bestimmen, die es nicht in der session gibt, um sie beim gegner f�r den kampf zu hinterlegen
  	  //////////////////////
  	  //////////////////////
  	  ...
  	  //hitpoints aus schiffgr��e berechnen
  	  $enm2['hp']=$enm2['ship_diameter']*1000;
  	  //anzahl der module f�r waffen/schilde reaktoren (-3 module f�r grundversorgung)
  	  $enm_fight_module=(2+round(sqrt($enm2['ship_diameter'])))*1.8;
  	  //feuerkraft/schilde berechnen, reaktoren werden aufgrund der �berlegenen technologie nicht ben�tigt, diese sind bereits integriert
  	  ...
  	  $fightdata=do_fight($enm1, $enm2);
  	  	  ...
  	  	  //�berpr�fen wer gewonnen/verloren hat
  ...
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  //�berpr�fen ob man vielleicht die hb verlassen m�chte
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  //linker teil mit der �bersicht
  /////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////
  
  //token f�r eine erkennung der automatisierung
  $_SESSION['sou_hb_token']=mt_rand(1000000,9999999);
