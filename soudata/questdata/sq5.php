...
if($canrecover>0)
{
  ...
  //25 stufen und 10k BK
  $needbk=ceil(($questlevel+1)/2.5)*1000;
  if($canrecover>=$needbk)
  {
      ...
      { 	  
		...
		$target_x=cos($winkel)*$questlevel*6;
		$target_y=sin($winkel)*$questlevel*6;
        ...
        if($questlevel>=25)
        {
          ...
          $quest_text='Du findest den Omega-Key und stellst ihn deiner Fraktion zur Verf&uuml;gung.';
          $quest_text.=' Die Aufgabe wurde vollst&auml;ndg abgeschlossen.';
          
          $chat_text='Fraktion '.$player_fraction.' hat folgende Aufgabe abgeschlossen: '.$questname.' (Stufe '.$questlevel.') - Die Fraktion verfügt jetzt &uuml;ber den Omega-Key.';
        }
        else
        {
		  //nachricht für den spieler / chat
		  $quest_text='Du findest nur einen alten Datenkristall mit neuen Koordinaten, von dem Omega-Key ist nichts zu sehen.';
...
/*
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=1, x=0,  y = 1500;
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=2, x= 1245, y = 825;
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=3, x=1245, y = -825;
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=4, x=0, y = -1500;
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=5, x= -1245, y = -825;
INSERT INTO sou_frac_quests SET id=5, questlevel=0, fraction=6, x= -1245, y = 825;
*/
