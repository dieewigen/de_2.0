...
if($canrecover>0 OR 1==1)//kein bergungsmodul notwendig
{
  ...
  if($canrecover>=$needbk)
  {
      ...
      if($num==1)
      {
          ...
          $quest_text='Du entdeckst den Punkt Aganra und stellst die Informationen Deiner Fraktion zur Verf&uuml;gung.';
          $quest_text.=' Die Aufgabe wurde vollst&auml;ndg abgeschlossen.';
          
          $chat_text='Fraktion '.$player_fraction.' hat folgende Aufgabe abgeschlossen: '.$questname.' - Die Fraktion hat den Punkt Aganra erreicht.';
...
/*
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=1, x=199995,  y = 0, hidexy=1;
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=2, x=199995,  y = 0, hidexy=1;
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=3, x=199995,  y = 0, hidexy=1;
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=4, x=199995,  y = 0, hidexy=1;
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=5, x=199995,  y = 0, hidexy=1;
INSERT INTO sou_frac_quests SET id=14, questlevel=0, fraction=6, x=199995,  y = 0, hidexy=1;
*/
