...
if($canrecover>0)
{
  ...
  $needbk=ceil(($questlevel+1)/10)*1500;
  if($canrecover>=$needbk)
  {
      ...
      { 	  
        ...
        if($questlevel>=10)
        {
          ...
          $quest_text='Du findest die Ehrenstatue und das Fraktionsansehen in deinem Heimatsystem steigt um '.number_format($spende, 0,"",".").' Punkte.';
        ...
        else
        {
		  ...
		  $quest_text='Du findest nur einen alten Datenkristall mit neuen Koordinaten, von der Ehrenstatue ist nichts zu sehen.';
...
/*
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=1, x=0,  y = 1500;
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=2, x= 1245, y = 825;
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=3, x=1245, y = -825;
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=4, x=0, y = -1500;
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=5, x= -1245, y = -825;
INSERT INTO sou_frac_quests SET id=4, questlevel=0, fraction=6, x= -1245, y = 825;
*/
