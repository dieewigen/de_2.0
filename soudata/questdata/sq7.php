...
if($canrecover>0)
{
  ...
  $needbk=ceil(($questlevel+1)/20)*1000;
  if($canrecover>=$needbk)
  {
      ...
      { 	  
        ...
        if($questlevel>=20)
        {
          ...
          $quest_text='Du findest ein wirklich wertvolles Artefakt und '.number_format($spende, 0,"",".").' Zastari werden der Fraktionskasse gutgeschrieben.';
        ...
        {	
		  ...
		  $quest_text='Du findest nur eine Raumboje mit neuen Koordinaten, von wertvollen Dingen ist nichts zu sehen.';
...
/*
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=1, x=0,  y = 1500;
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=2, x= 1245, y = 825;
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=3, x=1245, y = -825;
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=4, x=0, y = -1500;
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=5, x= -1245, y = -825;
INSERT INTO sou_frac_quests SET id=7, questlevel=0, fraction=6, x= -1245, y = 825;
*/
