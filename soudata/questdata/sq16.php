...
if($canrecover>0)//kein bergungsmodul notwendig
{
  ...
  {
    //überprüfen ob er 1 zalussplitte/specialres1 hat
    if($player_specialres[2]>=1)
    {
      ...
      if($num==1)
      {
          ...
          //zalussplitter abziehen
          mysql_query("UPDATE sou_user_data SET specialres2=specialres2-1 WHERE user_id = '$player_user_id'",$soudb);
          
          //allen spielern der fraktion ein bonusmodul geben
		  $ai=0;
		  $angebot[$ai][name]='Bergbaubonus Aganra';
		  $angebot[$ai][buff]='1x7x30';
		  $angebot[$ai][mapbuff]='';
          ...
          $quest_text='Du konntest mit Hilfe des Zalussplitters ein Artefakt aktivieren, welches wichtige Informationen enthalten hat. Alle Spieler Deiner Fraktion haben eine Belohnung erhalten, welche Sie in Ihrem Modulkomplex finden k&ouml;nnen.';
          $quest_text.=' Die Aufgabe wurde vollst&auml;ndg abgeschlossen.';
          
          $chat_text='Fraktion '.$player_fraction.' hat folgende Aufgabe abgeschlossen: '.$questname.' - Die Fraktion konnte mit Hilfe des Zalussplitters ein Artefakt aktivieren, welches wichtige Informationen enthalten hat. Alle Spieler der Fraktion haben eine Belohnung erhalten, welche Sie in Ihrem Modulkomplex finden k&ouml;nnen.';
    ...
    else $quest_text='<font color="FF0000">Du besitzt keinen Zalussplitter.';
  }
...
/*
INSERT INTO sou_frac_quests SET id=16, questlevel=0, fraction=0, x = 199997,  y = 4, hidexy=1;
*/
